...
我们在学习JavaScript函数式编程的时候，通常所说的Functor函子、AP函子、Monad函子的概念就来源此：Haskell函数式编程中Functor、Applicative 和 Monad。笔者也是受到这篇文章的启发，开发启动Haskell学习计划。这里推荐： [Haskell 趣學指南](https://legacy.gitbook.com/book/mno2/learnyouahaskell-zh/details/zh-cn)
